...
<br>
		<div id="content">
			<div class="leftborder=1" style="border-collapse:collapse;">
				<h4align="center" class="heading">Change Contents</h4><hr>
				<tablealign="center">
					<tr>
						<td><img src="img/news.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="home1.php" class="links_left" onclick>Home Page</a></td>
					</tr>
					<tr>
					<td><img src="img/news.png">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="Images.php" class="links_left" onclick>Images</a></td>
					</tr>
			...
			<div class="space"></div>
			<div class="center">
				<h1 style='color:white'>Update About page</h1><br>
